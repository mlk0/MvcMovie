...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,Rating,IsSoldOut")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,Rating,IsSoldOut")] Movie movie)
        {
            if (ModelState.IsValid)
            {
